...
function AboutPage() {
  return (
    <section className="relative bg-white dark:bg-gray-900 py-16 md:py-24 px-6 sm:px-8 md:px-12 lg:px-24 xl:px-32 overflow-hidden transition-colors duration-300">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-64 h-64 bg-blue-100 dark:bg-blue-900 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
      <div className="absolute bottom-0 right-0 w-64 h-64 bg-indigo-100 dark:bg-indigo-900 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        >
          <div className="relative group">
            ...
            />
            <div className="absolute inset-0 rounded-2xl border-4 border-white/30 dark:border-gray-700/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
          </div>
        </motion.div>
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 text-center lg:text-left">
            About <span className="text-blue-600 dark:text-blue-400">Me</span>
          </h1>

          <div className="space-y-6 text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
            <p>
              I’m <span className="font-semibold text-blue-600 dark:text-blue-400">Rajkumar Yogi</span>, a
            ...
            <p>
              ...
              <span className="font-semibold text-blue-600 dark:text-blue-400">AWS cloud services</span> such
          ...
          >
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-block px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 font-medium"
            >
              Get My CV →
            </a>
          </motion.div>
