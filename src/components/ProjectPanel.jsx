...
function ProjectPanel() {
  ...
  const Projects = [
    ...
    {
      title: "AI-Powered Summarizer(Summarize anything)",
      description:
        "Full-stack application that processes meeting transcripts with 90% accuracy using AI, generates executive summaries based on custom prompts also editable results, and enables email sharing of results.",
      live: "https://ai-meeting-notes-summarizer-seven.vercel.app",
      image: "/AI_Summarizer.png",
      tags: ["Node.js", "Express.js", "Groq API : model- llama-3.1-8b-instant", "Nodemailer", "Render"],
    },
    {
