            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>B116 Damodar Hostel, JNU, New Delhi, India (110067)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:work.yogirajkumar@gmail.com" className={`${darkMode ? 'text-gray-400 hover:text-blue-400' : 'text-gray-600 hover:text-blue-600'} transition`}>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+919785641782" className={`${darkMode ? 'text-gray-400 hover:text-blue-400' : 'text-gray-600 hover:text-blue-600'} transition`}>
                      +91 97856 41782
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  {[
                    { icon: <FaWhatsapp />, color: "text-green-600", href: "https://wa.me/919785641782" },
                    { icon: <FaLinkedin />, color: "text-blue-600", href: "https://www.linkedin.com/in/rajkumaryogi-jnu/" },
                    { icon: <FaGithub />, color: "text-gray-400", href: "https://github.com/Rajkumaryogi" },
